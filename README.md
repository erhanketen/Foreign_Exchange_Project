# Foreign_Exchange_Project
  A small foreign exchange project. The program displays current exchange rates and includes account-based customization.

# Account Customization
  The program has a login and register screen. Every account is kept in the database and it will pull the data when a user logs in. 
