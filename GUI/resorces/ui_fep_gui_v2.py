...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scroll_area_currencies = QScrollArea(self.home_page)
        ...
        self.scroll_content_currencies.setGeometry(QRect(0, 0, 881, 1192))
        ...
        self.gridLayout_4.addWidget(self.scroll_area_currencies, 2, 0, 1, 1)

        self.loading_frame = QFrame(self.home_page)
        ...
        self.verticalLayout_16 = QVBoxLayout(self.loading_frame)
        ...
        self.verticalLayout_16.addWidget(self.lbl_loading_rates)
        ...
        self.verticalLayout_16.addWidget(self.loading_bar)
        ...
        self.gridLayout_4.addWidget(self.loading_frame, 1, 0, 1, 1)
