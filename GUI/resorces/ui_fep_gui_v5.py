...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scroll_content_currencies.setGeometry(QRect(0, -762, 812, 1192))
        ...
        self.dsb_amount_eur.setMaximum(1000000.000000000000000)
        ...
        self.dsb_amount_usd.setMaximum(1000000.000000000000000)
        ...
        self.dsb_amount_gbp.setMaximum(1000000.000000000000000)
        ...
        self.dsb_amount_jpy.setMaximum(1000000.000000000000000)
        ...
        self.dsb_amount_chf.setMaximum(1000000.000000000000000)
        ...
        self.dsb_amount_cad.setMaximum(1000000.000000000000000)
        ...
        self.dsb_amount_aud.setMaximum(1000000.000000000000000)
        ...
        self.dsb_amount_cny.setMaximum(1000000.000000000000000)
        ...
        self.dsb_amount_try.setMaximum(1000000.000000000000000)
        ...
        self.dsb_amount_sar.setMaximum(1000000.000000000000000)
        ...
        self.dsb_amount_nzd.setMaximum(1000000.000000000000000)
        ...
        self.buying_page = QWidget()
        self.buying_page.setObjectName(u"buying_page")
        self.gridLayout = QGridLayout(self.buying_page)
        ...
        self.con_button = QPushButton(self.buying_page)
        self.con_button.setObjectName(u"con_button")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.con_button.sizePolicy().hasHeightForWidth())
        self.con_button.setSizePolicy(sizePolicy2)

        self.horizontalLayout_8.addWidget(self.con_button)

        self.dec_button = QPushButton(self.buying_page)
        self.dec_button.setObjectName(u"dec_button")
        sizePolicy2.setHeightForWidth(self.dec_button.sizePolicy().hasHeightForWidth())
        self.dec_button.setSizePolicy(sizePolicy2)

        self.horizontalLayout_8.addWidget(self.dec_button)
        ...
        self.frame = QFrame(self.buying_page)
        ...
        self.from_rate_lbl = QLabel(self.frame)
        self.from_rate_lbl.setObjectName(u"from_rate_lbl")
        self.from_rate_lbl.setFont(font3)
        self.from_rate_lbl.setAlignment(Qt.AlignCenter)

        self.horizontalLayout.addWidget(self.from_rate_lbl)

        self.from_rate_amount_lbl = QLabel(self.frame)
        self.from_rate_amount_lbl.setObjectName(u"from_rate_amount_lbl")

        self.horizontalLayout.addWidget(self.from_rate_amount_lbl)
        ...
        self.converting_to_lbl = QLabel(self.buying_page)
        self.converting_to_lbl.setObjectName(u"converting_to_lbl")
        self.converting_to_lbl.setFont(font3)
        self.converting_to_lbl.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_5.addWidget(self.converting_to_lbl)

        self.frame_2 = QFrame(self.buying_page)
        ...
        self.to_rate_lbl = QLabel(self.frame_2)
        self.to_rate_lbl.setObjectName(u"to_rate_lbl")
        self.to_rate_lbl.setFont(font3)
        self.to_rate_lbl.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_3.addWidget(self.to_rate_lbl)

        self.to_rate_amount_lbl = QLabel(self.frame_2)
        self.to_rate_amount_lbl.setObjectName(u"to_rate_amount_lbl")

        self.horizontalLayout_3.addWidget(self.to_rate_amount_lbl)
        ...
        self.stackedWidget_2.addWidget(self.buying_page)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 812, 657))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.con_button.setText(QCoreApplication.translate("MainWindow", u"Confirm Exchanging", None))
        self.dec_button.setText(QCoreApplication.translate("MainWindow", u"Decline Exchanging", None))
        self.from_rate_lbl.setText(QCoreApplication.translate("MainWindow", u"rate symbol \u20ac", None))
        self.from_rate_amount_lbl.setText(QCoreApplication.translate("MainWindow", u"Amount & rate name", None))
        self.converting_to_lbl.setText(QCoreApplication.translate("MainWindow", u"converting to", None))
        self.to_rate_lbl.setText(QCoreApplication.translate("MainWindow", u"rate symbol \u20ac", None))
        self.to_rate_amount_lbl.setText(QCoreApplication.translate("MainWindow", u"Amount & rate name", None))
